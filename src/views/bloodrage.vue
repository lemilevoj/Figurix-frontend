  ...
  data() {
    ...
    methods:{
      ...
      dodajDogadaj(){
        ...
        let noviDogadaj =  Dogadaji.dodaj_dogadaj3(dogadaji);
    ...
    async created(){
      ...
      this.objave = await Dogadaji.dohvatiBloodRage();
      this.drugeobjave = JSON.parse(localStorage.getItem('bloodrage'));
      console.log(JSON.parse(localStorage.getItem('bloodrage')));	
    }
}
</script>
