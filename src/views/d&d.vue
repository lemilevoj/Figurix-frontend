  ...
  data() {
    ...
    methods:{
      ...
      dodajDogadaj(){
        ...
        let noviDogadaj =  Dogadaji.dodaj_dogadaj5(dogadaji);
    ...
    async created(){
      ...
      this.objave = await Dogadaji.dohvatiDnd();
      this.drugeobjave = JSON.parse(localStorage.getItem('dnd'));
      console.log(JSON.parse(localStorage.getItem('dnd')));	
    }
}
</script>
