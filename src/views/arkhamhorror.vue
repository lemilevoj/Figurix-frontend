  ...
  data() {
    ...
    methods:{
      ...
      dodajDogadaj(){
        ...
        let noviDogadaj =  Dogadaji.dodaj_dogadaj2(dogadaji);
    ...
    async created(){
      ...
      this.objave = await Dogadaji.dohvatiArkhamHorror();
      this.drugeobjave = JSON.parse(localStorage.getItem('arkhamhorror'));
      console.log(JSON.parse(localStorage.getItem('arkhamhorror')));	
    }
}
</script>
