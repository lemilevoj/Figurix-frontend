  ...
  data() {
    ...
    methods:{
      ...
      dodajDogadaj(){
        ...
        let noviDogadaj =  Dogadaji.dodaj_dogadaj6(dogadaji);
    ...
    async created(){
      ...
      this.objave = await Dogadaji.dohvatiLostCities();
      this.drugeobjave = JSON.parse(localStorage.getItem('lostcities'));
      console.log(JSON.parse(localStorage.getItem('lostcities')));	
    }
}
</script>
