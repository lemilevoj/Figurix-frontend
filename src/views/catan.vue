  ...
  data() {
    ...
    methods:{
      ...
      dodajDogadaj(){
        ...
        let noviDogadaj =  Dogadaji.dodaj_dogadaj4(dogadaji);
    ...
    async created(){
      ...
      this.objave = await Dogadaji.dohvatiCatan();
      this.drugeobjave = JSON.parse(localStorage.getItem('catan'));
      console.log(JSON.parse(localStorage.getItem('catan')));	
    }
}
</script>
