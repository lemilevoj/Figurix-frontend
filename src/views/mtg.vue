  ...
  data() {
    ...
    methods:{
      ...
      dodajDogadaj(){
        ...
        let noviDogadaj =  Dogadaji.dodaj_dogadaj7(dogadaji);
    ...
    async created(){
      ...
      this.objave = await Dogadaji.dohvatimtg();
      this.drugeobjave = JSON.parse(localStorage.getItem('mtg'));
      console.log(JSON.parse(localStorage.getItem('mtg')));	
    }
}
</script>
