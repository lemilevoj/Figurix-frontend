  ...
  data() {
    ...
    methods:{
      ...
      dodajDogadaj(){
        ...
        let noviDogadaj =  Dogadaji.dodaj_dogadaj12(dogadaji);
    ...
    async created(){
      ...
      this.objave = await Dogadaji.dohvatiYugioh();
      this.drugeobjave = JSON.parse(localStorage.getItem('yugioh'));
      console.log(JSON.parse(localStorage.getItem('yugioh')));	
    }
}
</script>
