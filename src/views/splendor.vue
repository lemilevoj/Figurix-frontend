  ...
  data() {
    ...
    methods:{
      ...
      dodajDogadaj(){
        ...
        let noviDogadaj =  Dogadaji.dodaj_dogadaj10(dogadaji);
    ...
    async created(){
      ...
      this.objave = await Dogadaji.dohvatiSplendor();
      this.drugeobjave = JSON.parse(localStorage.getItem('splendor'));
      console.log(JSON.parse(localStorage.getItem('splendor')));	
    }
}
</script>
